...
[lib/k8s/token.ts:8](https://github.com/kinvolk/headlamp/blob/16fcc2a7/frontend/src/lib/k8s/token.ts#L8)
...
[lib/k8s/token.ts:4](https://github.com/kinvolk/headlamp/blob/16fcc2a7/frontend/src/lib/k8s/token.ts#L4)
