...
[lib/k8s/mutatingWebhookConfiguration.ts:24](https://github.com/headlamp-k8s/headlamp/blob/e3b4c5c7/frontend/src/lib/k8s/mutatingWebhookConfiguration.ts#L24)
