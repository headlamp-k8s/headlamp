...
function NotificationsList(props: {
  ...
  clickEventHandler: (notification?: INotification, closeMenu?: boolean) => void;
}) {
  ...
  function notificationSeenUnseenHandler(event: any, notification?: INotification) {
  ...
  function notificationItemClickHandler(notification: INotification) {
...
export default function Notifications() {
  ...
  useEffect(() => {
    let notificationsToShow: INotification[] = [];
  ...
  function menuItemClickHandler(notification?: INotification, closeMenu?: boolean) {
    if (notification) {
