...
export function PluginSettingsPure(props: PluginSettingsPureProps) {
  ...
  /**
   * Plugin array derived from prop data (copy, not original state).
   * This array is the main array used for rendering plugin info and handling switch changes.
   * Modifications done here (e.g., splitting names, toggling enable switch) are what will be rendered.
   */
  ...
  }, [pendingPluginsEnabled, pluginArr, props.pluginsEnabledMap]);
