        ...
        {item === null ?
          ...
          <React.Fragment>
            ...
            >
              ...
              <InfoLabel name="Version" value={item.metadata.namespace} />
              ...
              <InfoLabel name="Capacity" value={item.spec.resources.requests.storage} />
              <InfoLabel name="Access Modes" value={item.spec.accessModes.join(', ')} />
              <InfoLabel name="Volume Mode" value={item.spec.volumeMode} />
