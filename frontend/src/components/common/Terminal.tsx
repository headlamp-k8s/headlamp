...
interface ContainerSelectionProps {
  item: Pod;
  containerFormControlClass: string;
  container: string;
  setContainer: (container: string) => void;
}

function ContainerSelection(props: ContainerSelectionProps) {
  const { item, container, containerFormControlClass, setContainer } = props;
  ...
  return (
    <Box>
      <FormControl className={containerFormControlClass}>
      ...
      <DialogContent className={classes.dialogContent}>
        {isPod(item) ? (
          <ContainerSelection
            ...
            containerFormControlClass={classes.containerFormControl}
          />
        ) : (
          <></>
        )}
