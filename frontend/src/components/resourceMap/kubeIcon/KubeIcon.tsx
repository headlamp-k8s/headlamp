...
const kindGroupColors = {
  workloads: 'oklch(75.85% 0.12 167.18)',
  storage: 'oklch(75.85% 0.12 46.47)',
  network: 'oklch(75.85% 0.12 225.16)',
  security: 'oklch(75.85% 0.12 275.16)',
  configuration: 'oklch(75.85% 0.12 320.03)',
  other: 'oklch(75.85% 0 215.25)',
} as const;
