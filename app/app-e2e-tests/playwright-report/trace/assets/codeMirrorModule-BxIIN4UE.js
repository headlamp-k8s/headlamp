import { n as mu, o as bu } from './testServerConnection-JQMZFCzK.js';
var ho = { exports: {} },
  ha;
function Ar() {
  return (
      ...
      (function (yr, Or) {
        (function (F, Ee) {
          ...
          var F = navigator.userAgent,
            ...
            V = /Android/.test(F),
            oe = ae || V || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(F),
            xe = ae || /Mac/.test(Ee),
            _e = /\bCrOS\b/.test(F),
            ye = /win/i.test(Ee),
          ...
          function C(e, t) {
            var n;
            return (
              Object.create ? (n = Object.create(e)) : ((A.prototype = e), (n = new A())),
              t && de(t, n),
              n
            );
          }
          var be =
            /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
          function R(e) {
            return /\w/.test(e) || (e > '' && (e.toUpperCase() != e.toLowerCase() || be.test(e)));
          }
          function ne(e, t) {
          ...
          var gi = (function () {
            ...
            return function (u, d) {
              ...
              for (var m = u.length, y = [], S = 0; S < m; ++S) y.push(n(u.charCodeAt(S)));
              ...
              for (var Fe = 0; Fe < m; ++Fe) {
                ...
                if (it == ',') y[Fe] = 'N';
                  ...
                  for (
                    var Nt = (Fe && y[Fe - 1] == '!') || (Ue < m && y[Ue] == '1') ? '1' : 'N',
                      wt = Fe;
                    wt < Ue;
                    ++wt
                  )
              ...
              return (
                d == 'ltr' &&
                  (dt[0].level == 1 &&
                    (Xt = u.match(/^\s+/)) &&
                    ((dt[0].from = Xt[0].length), dt.unshift(new s(0, 0, Xt[0].length))),
                  re(dt).level == 1 &&
                    (Xt = u.match(/\s+$/)) &&
                    ((re(dt).to -= Xt[0].length), dt.push(new s(0, m - Xt[0].length, m)))),
                d == 'rtl' ? dt.reverse() : dt
              );
            };
          })();
...
`,
          ...
          function Ir(e) {
            if (typeof e == 'string' && Wt.hasOwnProperty(e)) e = Wt[e];
              ...
              var t = Wt[e.name];
              typeof t == 'string' && (t = { name: t }), (e = C(t, e)), (e.name = t.name);
            } else {
          ...
          function k(e, t, n) {
            if ((n === void 0 && (n = null), !(this instanceof k))) return new k(e, t, n);
          ...
          function fe(e, t) {
            ...
            return t.line > n ? k(n, U(e, n).text.length) : ba(t, U(e, t.line).text.length);
          }
          function ba(e, t) {
            var n = e.ch;
          ...
          (qt.prototype.lookAhead = function (e) {
            ...
            (qt.fromSaved = function (e, t, n) {
              return t instanceof Bn
                ? new qt(e, Ut(e.mode, t.state), n, t.lookAhead)
                : new qt(e, Ut(e.mode, t), n);
            }),
                  ...
                  (n.state = !0),
                    ko(
                      ...
                      function (y, S) {
                        for (var N = p; m < y; ) {
                          var z = i[p];
                          z > y && i.splice(p, 1, y, i[p + 1], z), (p += 2), (m = Math.min(y, z));
                        }
                        if (S)
                          if (d.opaque) i.splice(N, p - N, y, 'overlay ' + S), (p = N + 2);
                          else
                            for (; N < p; N += 2) {
                              var P = i[N + 1];
                              i[N + 1] = (P ? P + ' ' : '') + 'overlay ' + S;
          ...
          function yo(e, t, n) {
            if (!t.styles || t.styles[0] != e.state.modeGen) {
              var r = fn(e, f(t)),
                i = t.text.length > e.options.maxHighlightLength && Ut(e.doc.mode, r.state),
                o = go(e, t, r);
              i && (r.state = i),
          ...
          function fn(e, t, n) {
            ...
            var o = xa(e, t, n),
              ...
              a = l ? qt.fromSaved(r, l, o) : new qt(r, _r(r.mode), o);
            return (
          ...
          function xo(e, t, n, r) {
            ...
            for (r && (d = []); (r || u.pos < t.ch) && !u.eol(); )
              (u.start = u.pos),
                (l = xi(o, u, s.state)),
                r && d.push(new bo(u, l, Ut(i.mode, s.state)));
            return r ? d : new bo(u, l, s.state);
          }
          function wo(e, t) {
            if (e)
              for (;;) {
          ...
          function ko(e, t, n, r, i, o, l) {
            ...
            for (t == '' && wo(mo(n, r.state), o); !d.eol(); ) {
              if (
                (d.pos > e.options.maxHighlightLength
                  ? ((a = !1), l && bi(e, t, r, d.pos), (d.pos = t.length), (p = null))
                  : (p = wo(xi(n, d, r.state, m), o)),
                m)
              ) {
                var y = m[0].name;
                y && (p = 'm-' + (p ? y + ' ' + p : y));
          ...
          function xa(e, t, n) {
            for (
              ...
              var s = U(o, a - 1),
                u = s.stateAfter;
              if (u && (!n || a + (u instanceof Bn ? u.lookAhead : 0) <= o.modeFrontier)) return a;
            ...
            if (!u) {
              ...
              if (W > 0 && a)
                for (var B = 0; B < a.length; ++B)
                  a[B].to == null && (E || (E = [])).push(new Rn(a[B].marker, null, null));
              ...
              (e.iter(t.line, n.line + 1, function (y) {
                if (y.markedSpans)
                  for (var S = 0; S < y.markedSpans.length; ++S) {
                    ...
                    N.readOnly && (!r || q(r, N) == -1) && (r || (r = [])).push(N);
                  }
              }),
              !r)
            )
              ...
              for (var l = r[o], a = l.find(0), s = 0; s < i.length; ++s) {
                ...
                if (!(I(u.to, a.from) < 0 || I(u.from, a.to) > 0)) {
                  var d = [s, 1],
                    p = I(u.from, a.from),
                    m = I(u.to, a.to);
                  (p < 0 || (!l.inclusiveLeft && !p)) && d.push({ from: u.from, to: a.from }),
                    (m > 0 || (!l.inclusiveRight && !m)) && d.push({ from: a.to, to: u.to }),
                    i.splice.apply(i, d),
                    (s += d.length - 3);
                }
              }
          ...
          function Ht(e) {
            for (var t; (t = No(e)); ) e = t.find(-1, !0).line;
            return e;
          }
          function Aa(e) {
            for (var t; (t = qn(e)); ) e = t.find(1, !0).line;
            return e;
          }
          function Oa(e) {
            for (var t, n; (t = qn(e)); ) (e = t.find(1, !0).line), (n || (n = [])).push(e);
            return n;
          }
          function Si(e, t) {
            var n = U(e, t),
          ...
          function zo(e, t) {
            ...
            for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
              ...
              Ba(o, r, yo(e, o, a)),
                ...
                r.map.length == 0 && r.map.push(0, 0, r.content.appendChild(_n(e.display.measure))),
                i == 0
            ...
            return (
              qe(e, 'renderLine', e, t.line, r.pre),
              r.pre.className && (r.textClass = K(r.pre.className, r.textClass || '')),
              r
            );
          }
          function Fa(e) {
          ...
          function Wa(e, t, n, r, i, o, l) {
            if (t) {
              var a = e.splitSpaces ? _a(t, e.trailingSpace) : t,
                ...
                for (var p = 0; ; ) {
                  ...
                  if (m[0] == '	') {
                    ...
                    m[0] ==
                      `
`
                      ? ((N = d.appendChild(c('span', m[0] == '\r' ? '␍' : '␤', 'cm-invalidchar'))),
              ...
              if (
                ...
                if (l)
                  for (var B in l)
                    l.hasOwnProperty(B) && B != 'style' && B != 'class' && E.setAttribute(B, l[B]);
          ...
          function Ba(e, t, n) {
            ...
            if (!r) {
              for (var l = 1; l < n.length; l += 2)
                t.addToken(t, i.slice(o, (o = n[l])), Oo(n[l + 1], t.cm.options));
              return;
            }
            for (var a = i.length, s = 0, u = 1, d = '', p, m, y = 0, S, N, z, P, W; ; ) {
              if (y == s) {
                (S = N = z = m = ''), (W = null), (P = null), (y = 1 / 0);
                for (var E = [], B = void 0, Q = 0; Q < r.length; ++Q) {
                  var Z = r[Q],
                    ge = Z.marker;
                  if (ge.type == 'bookmark' && Z.from == s && ge.widgetNode) E.push(ge);
                  else if (
                    Z.from <= s &&
                    (Z.to == null || Z.to > s || (ge.collapsed && Z.to == s && Z.from == s))
                  ) {
                    if (
                      (Z.to != null && Z.to != s && y > Z.to && ((y = Z.to), (N = '')),
                      ge.className && (S += ' ' + ge.className),
                      ge.css && (m = (m ? m + ';' : '') + ge.css),
                      ge.startStyle && Z.from == s && (z += ' ' + ge.startStyle),
                      ge.endStyle && Z.to == y && (B || (B = [])).push(ge.endStyle, Z.to),
                      ge.title && ((W || (W = {})).title = ge.title),
                      ge.attributes)
                    )
                      for (var Fe in ge.attributes) (W || (W = {}))[Fe] = ge.attributes[Fe];
                    ge.collapsed && (!P || ki(P.marker, ge) < 0) && (P = Z);
                  } else Z.from > s && y > Z.from && (y = Z.from);
                }
                if (B)
                  for (var it = 0; it < B.length; it += 2) B[it + 1] == y && (N += ' ' + B[it]);
                if (!P || P.from == s) for (var Ue = 0; Ue < E.length; ++Ue) Po(t, 0, E[Ue]);
                if (P && (P.from || 0) == s) {
                  if (
                    (Po(t, (P.to == null ? a + 1 : P.to) - s, P.marker, P.from == null),
                    P.to == null)
                  )
                    return;
                  P.to == s && (P = !1);
              ...
              for (var Nt = Math.min(a, y); ; ) {
                if (d) {
                  ...
                  if (!P) {
                    ...
                    t.addToken(t, Ze, p ? p + S : S, z, s + Ze.length == y ? N : '', m, W);
                  }
                  if (wt >= Nt) {
                    (d = d.slice(Nt - s)), (s = Nt);
                    break;
                ...
                (d = i.slice(o, (o = n[u++]))), (p = Oo(n[u++], t.cm.options));
              }
            }
          }
          function Eo(e, t, n) {
          ...
          function jn(e, t, n) {
            for (var r = [], i, o = t; o < n; o = i) {
              var l = new Eo(e.doc, U(e.doc, o), o);
              (i = o + l.size), r.push(l);
            }
            return r;
          }
          ...
          function tt(e, t) {
            ...
            if (n.length) {
              var r = Array.prototype.slice.call(arguments, 2),
                i;
              Rr ? (i = Rr.delayedCallbacks) : dn ? (i = dn) : ((i = dn = []), setTimeout(qa, 0));
              for (
                var o = function (a) {
                    i.push(function () {
          ...
          function Qa(e, t) {
            t = Ht(t);
            var n = f(t),
              r = (e.display.externalMeasured = new Eo(e.doc, t, n));
            r.lineN = n;
            var i = (r.built = zo(e, r));
          ...
          function Kr(e, t) {
            ...
            r && !r.text
              ? (r = null)
              : r && r.changes && (Io(e, r, n, Ei(e)), (e.curOp.forceUpdate = !0)),
              r || (r = Qa(e, t));
            var i = Ro(r, t, n);
            return {
              line: t,
            ...
            return (
              t.cache.hasOwnProperty(o)
                ...
                : (t.rect || (t.rect = t.view.text.getBoundingClientRect()),
                  t.hasHeights || (Ja(e, t.view, t.rect), (t.hasHeights = !0)),
                  (l = $a(e, t, n, r)),
                  l.bogus || (t.cache[o] = l)),
              {
                left: l.left,
          ...
          function $a(e, t, n, r) {
            ...
            if (o.nodeType == 3) {
              for (var d = 0; d < 4; d++) {
                ...
                for (; i.coverStart + a < i.coverEnd && ve(t.line.text.charAt(i.coverStart + a)); )
                  ++a;
                if (
                  (M && j < 9 && l == 0 && a == i.coverEnd - i.coverStart
                    ? (u = o.parentNode.getBoundingClientRect())
                    : (u = Va(b(o, l, a).getClientRects(), r)),
                  u.left || u.right || l == 0)
                )
                  break;
                (a = l), (l = l - 1), (s = 'right');
              }
              M && j < 11 && (u = es(e.display.measure, u));
            } else {
              l > 0 && (s = r = 'right');
              var p;
          ...
          function Yn(e, t, n, r, i) {
            ...
            if (
              ...
              l += a.top + (r == 'window' ? 0 : Yo(pe(e)));
              var s = a.left + (r == 'window' ? 0 : Xo(pe(e)));
              (n.left += s), (n.right += s);
            }
          ...
          function Zn(e, t, n, r, i) {
            return r || (r = U(e.doc, t.line)), Yn(e, r, Ko(e, r, t.ch, i), n);
          }
          ...
          function Jo(e, t) {
            var n = 0;
            (t = fe(e.doc, t)), e.options.lineWrapping || (n = qr(e.display) * t.ch);
          ...
          function zi(e, t, n) {
            var r = e.doc;
            if (((n += e.display.viewOffset), n < 0)) return Oi(r.first, 0, null, -1, -1);
            var i = h(r, n),
              o = r.first + r.size - 1;
            if (i > o) return Oi(r.first + r.size - 1, U(r, o).text.length, null, 1, 1);
            t < 0 && (t = 0);
            for (var l = U(r, i); ; ) {
              var a = ts(e, l, i, t, n),
                s = Da(l, a.ch + (a.xRel > 0 || a.outside > 0 ? 1 : 0));
              if (!s) return a;
              var u = s.find(1);
          ...
          function ts(e, t, n, r, i) {
            ...
            if (d) {
              var p = (e.options.lineWrapping ? ns : rs)(e, t, n, o, d, r, i);
              ...
              S = Ot(
                function (Q) {
                  ...
                  return (
                    (Z.top += l),
                    (Z.bottom += l),
                    Pi(Z, r, i, !1) ? (Z.top <= i && Z.left <= r && ((m = Q), (y = Z)), !0) : !1
                  );
                },
                a,
                s
          ...
          function rs(e, t, n, r, i, o, l) {
            var a = Ot(
                function (p) {
                  var m = i[p],
                    y = m.level != 1;
                  return Pi(
                    Bt(e, k(n, y ? m.to : m.from, y ? 'before' : 'after'), 'line', t, r),
                    o,
                    l,
                    !0
                  );
            ...
            if (a > 0) {
              var u = s.level != 1,
                d = Bt(e, k(n, u ? s.from : s.to, u ? 'after' : 'before'), 'line', t, r);
          ...
          function $o(e) {
            var t = Ur(e.display),
              ...
              r = n && Math.max(5, e.display.scroller.clientWidth / qr(e.display) - 3);
            return function (i) {
          ...
          function kr(e, t, n, r) {
            ...
            if (r && s.xRel > 0 && (u = U(e.doc, s.line).text).length == s.ch) {
              ...
              s = k(s.line, Math.max(0, Math.round((o - Bo(e.display).left) / qr(e.display)) - d));
            }
            return s;
          }
          function Sr(e, t) {
          ...
          function bt(e, t, n, r) {
            ...
            if (
              ...
              Jt && Ao(e.doc, n + r) > i.viewFrom ? fr(e) : ((i.viewFrom += r), (i.viewTo += r));
            ...
            (e.state.delayingBlurEvent = !0),
              setTimeout(function () {
                e.state.delayingBlurEvent &&
                  ((e.state.delayingBlurEvent = !1), e.state.focused && Gr(e));
              }, 100);
          }
          function Bi(e, t) {
              ...
              if (!a.hidden) {
                if (((i += a.line.height), M && j < 8)) {
                  ...
                  (u = m.bottom - m.top),
                    !s &&
                      a.text.firstChild &&
                      (d = a.text.firstChild.getBoundingClientRect().right - m.left - 1);
                }
                var y = a.line.height - u;
                if (
                  (y > 0.005 || y < -0.005) &&
                  (i < r && (o -= y), Dt(a.line, u), nl(a.line), a.rest)
                )
                  for (var S = 0; S < a.rest.length; S++) nl(a.rest[S]);
                if (d > e.display.sizerWidth) {
                  var N = Math.ceil(d / qr(e.display));
          ...
          function as(e, t, n, r) {
            ...
            !e.options.lineWrapping &&
              ...
              (t = t.ch ? k(t.line, t.sticky == 'before' ? t.ch - 1 : t.ch, 'after') : t));
            for (var o = 0; o < 5; o++) {
              var l = !1,
                a = Bt(e, t),
                s = !n || n == t ? a : Bt(e, n);
              ...
              if (
                ...
                u.scrollLeft != null &&
                  (Cr(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - p) > 1 && (l = !0)),
                !l)
              )
                break;
            }
          ...
          function ss(e, t) {
            var n = Ri(e, t);
            n.scrollTop != null && mn(e, n.scrollTop), n.scrollLeft != null && Cr(e, n.scrollLeft);
          }
          function Ri(e, t) {
            var n = e.display,
              r = Ur(e.display);
            ...
            return (
              ...
              t.left < 10
                ...
                : t.right > y + m - 3 && (l.scrollLeft = t.right + (S ? 0 : 10) - y),
              l
            );
          }
          function Ki(e, t) {
          ...
          function mn(e, t) {
            Math.abs(e.doc.scrollTop - t) < 2 ||
              (Se || qi(e, { top: t }), ol(e, t, !0), Se && qi(e), wn(e, 100));
          }
          function ol(e, t, n) {
            (t = Math.max(
              0,
          ...
          function cs(e) {
            for (var t = e.ops, n = 0; n < t.length; n++) ds(t[n]);
            for (var r = 0; r < t.length; r++) hs(t[r]);
            for (var i = 0; i < t.length; i++) ps(t[i]);
            for (var o = 0; o < t.length; o++) vs(t[o]);
            for (var l = 0; l < t.length; l++) gs(t[l]);
          }
          function ds(e) {
            var t = e.cm,
              n = t.display;
          ...
          function ps(e) {
            ...
            e.updatedDisplay && Vn(t),
              ...
              n.maxLineChanged &&
                ...
                ((e.adjustWidthTo = Ko(t, n.maxLine, n.maxLine.text.length).left + 3),
          ...
          function gs(e) {
            ...
            if (o) for (var a = 0; a < o.length; ++a) o[a].lines.length || qe(o[a], 'hide');
            if (l) for (var s = 0; s < l.length; ++s) l[s].lines.length && qe(l[s], 'unhide');
            n.wrapper.offsetHeight && (r.scrollTop = t.display.scroller.scrollTop),
              e.changeObjs && qe(t, 'changes', t, e.changeObjs),
          ...
          function wn(e, t) {
            e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, te(ys, e));
          }
          function ys(e) {
            var t = e.doc;
            if (!(t.highlightFrontier >= e.display.viewTo)) {
              ...
              t.iter(r.line, Math.min(t.first + t.size, e.display.viewTo + 500), function (o) {
                if (r.line >= e.display.viewFrom) {
                  var l = o.styles,
                    a = o.text.length > e.options.maxHighlightLength ? Ut(t.mode, r.state) : null,
                    s = go(e, o, r, !0);
                  ...
                  for (
                    var p =
                        ...
                        (u != d &&
                          (!u || !d || u.bgClass != d.bgClass || u.textClass != d.textClass)),
                      m = 0;
                    !p && m < l.length;
                    ++m
                  )
          ...
          (ti.prototype.signal = function (e, t) {
            ...
            (ti.prototype.finish = function () {
              for (var e = 0; e < this.events.length; e++) qe.apply(null, this.events[e]);
            });
          function ms(e) {
            var t = e.display;
            !t.scrollbarsClipped &&
          ...
          function Ui(e, t) {
            ...
            return (
              ...
              ws(e, n.updateLineNumbers, t.dims),
            ...
            for (var n = t.viewport, r = !0; ; r = !1) {
              if (!r || !e.options.lineWrapping || t.oldDisplayWidth == xr(e)) {
                if (
                  (n &&
                    n.top != null &&
                    (n = { top: Math.min(e.doc.height + Mi(e.display) - Ni(e), n.top) }),
            ...
            for (var s = r.view, u = r.viewFrom, d = 0; d < s.length; d++) {
              ...
              if (!p.hidden)
                if (!p.node || p.node.parentNode != o) {
                  ...
                  p.changes && (q(p.changes, 'gutter') > -1 && (y = !1), Io(e, p, u, n)),
                    y &&
                      (T(p.lineNumber),
                      p.lineNumber.appendChild(document.createTextNode(O(e.options, u)))),
          ...
          function ji(e, t) {
            (e.display.sizer.style.minHeight = t.docHeight + 'px'),
              ...
              (e.display.gutters.style.height = t.docHeight + e.display.barHeight + Gt(e) + 'px');
          }
          function fl(e) {
            var t = e.display,
              n = t.view;
          ...
          function ks(e, t, n, r) {
            ...
            (i.mover = c('div', [o], null, 'position: relative')),
              ...
              G && se >= 105 && (i.wrapper.style.clipPath = 'inset(0px)'),
          ...
          var ri = 0,
            $t = null;
          M ? ($t = -0.53) : Se ? ($t = 15) : G ? ($t = -0.7) : Ie && ($t = -1 / 3);
          function hl(e) {
            var t = e.wheelDeltaX,
              n = e.wheelDeltaY;
            return (
          ...
          function pl(e, t) {
            ...
            if ((r && s) || (i && u)) {
              ...
              if (i && o != null) {
                ...
                y < 0 ? (S = Math.max(0, S + y - 50)) : (N = Math.min(e.doc.height, N + y + 50)),
                  qi(e, { top: S, bottom: N });
              }
              ri < 20 &&
                t.deltaMode !== 0 &&
                    ...
                    setTimeout(function () {
                      if (l.wheelStartX != null) {
                        var z = a.scrollLeft - l.wheelStartX,
                          ...
                          W =
                            (P && l.wheelDY && P / l.wheelDY) || (z && l.wheelDX && z / l.wheelDX);
          ...
          function Yi(e, t) {
            for (var n = [], r = 0; r < e.sel.ranges.length; r++) {
              ...
              n.push(new Ae(vl(i.anchor, t), vl(i.head, t)));
            }
          ...
          function Ji(e, t, n, r) {
            ...
            if (t.full) e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length);
              ...
              o(p, p.text, y), S && e.remove(a.line, S), N.length && e.insert(a.line, N);
            } else if (d == p)
              if (u.length == 1) o(d, d.text.slice(0, a.ch) + m + d.text.slice(s.ch), y);
              else {
              ...
              o(d, d.text.slice(0, a.ch) + u[0], i(0)), o(p, m + p.text.slice(s.ch), y);
          ...
          function Ls(e, t) {
            if (t) return xl(e.done), re(e.done);
          ...
          function Ns(e, t, n, r) {
            ...
            (o &&
              i.lastSelOrigin == o &&
              ((i.lastModTime == i.lastSelTime && i.lastOrigin == o) || Ms(e, o, re(i.done), t)))
          ...
          function As(e, t) {
            var n = t['spans_' + e.id];
            if (!n) return null;
            for (var r = [], i = 0; i < t.text.length; ++i) r.push(Ds(n[i]));
            return r;
          }
          function Sl(e, t) {
            var n = As(e, t),
          ...
          function Os(e, t, n) {
            ...
            return (
              qe(e, 'beforeSelectionChange', e, r),
              e.cm && qe(e.cm, 'beforeSelectionChange', e.cm, r),
          ...
          function ct(e, t, n) {
            li(e, t, n), Ns(e, e.sel, e.cm ? e.cm.curOp.id : NaN, n);
          }
          function li(e, t, n) {
            (Lt(e, 'beforeSelectionChange') || (e.cm && Lt(e.cm, 'beforeSelectionChange'))) &&
              (t = Os(e, t, n));
            var r = (n && n.bias) || (I(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
            Ml(e, Dl(e, t, r, !0)),
              !(n && n.scroll === !1) &&
                e.cm &&
          ...
          function Ml(e, t) {
            t.equals(e.sel) ||
              ((e.sel = t),
              e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), zt(e.cm)),
              tt(e, 'cursorActivity', e));
          }
          function Nl(e) {
            Ml(e, Dl(e, e.sel, null, !1));
          }
          function Dl(e, t, n, r) {
            ...
            if (o.markedSpans)
              for (var l = 0; l < o.markedSpans.length; ++l) {
                ...
                if (
                  ...
                  if (i && (qe(s, 'beforeCursorEnter'), s.explicitlyCleared))
                    if (o.markedSpans) {
                      --l;
                      continue;
                    } else break;
                  ...
                  if (n) {
                    var p = s.find(r < 0 ? 1 : -1),
                      m = void 0;
                    if (
                      ((r < 0 ? d : u) && (p = Al(e, p, -r, p && p.line == t.line ? o : null)),
                      p && p.line == t.line && (m = I(p, n)) && (r < 0 ? m < 0 : m > 0))
                    )
                      return Zr(e, p, t, r, i);
                  }
                  var y = s.find(r < 0 ? -1 : 1);
                  return (
                    (r < 0 ? u : d) && (y = Al(e, y, r, y.line == t.line ? o : null)),
                    y ? Zr(e, y, t, r, i) : null
                  );
                }
              }
          ...
          function zl(e, t, n) {
            ...
            return (
              ...
              qe(e, 'beforeChange', e, r),
              e.cm && qe(e.cm, 'beforeChange', e.cm, r),
              r.canceled
          ...
          function Pl(e, t) {
            if (!(t.text.length == 1 && t.text[0] == '' && I(t.from, t.to) == 0)) {
              var n = Yi(e, t);
              wl(e, t, n, e.cm ? e.cm.curOp.id : NaN), Cn(e, t, n, wi(e, t));
              var r = [];
              hr(e, function (i, o) {
                !o && q(r, i.history) == -1 && (Wl(i.history, t), r.push(i.history)),
                  Cn(i, t, null, wi(i, t));
              });
            }
          }
              ...
              if (u != a.length) {
                ...
                for (
                  var p = Lt(e, 'beforeChange') || (e.cm && Lt(e.cm, 'beforeChange')),
                    m = function (N) {
                      var z = o.changes[N];
                      if (((z.origin = t), p && !zl(e, z, !1))) return (a.length = 0), {};
                      d.push(Qi(e, z));
                      var P = N ? Yi(e, z) : re(a);
                      Cn(e, z, P, Sl(e, z)),
                        !N && e.cm && e.cm.scrollIntoView({ from: z.from, to: dr(z) });
                      var W = [];
                      hr(e, function (E, B) {
                        !B && q(W, E.history) == -1 && (Wl(E.history, z), W.push(E.history)),
                          Cn(E, z, null, Sl(E, z));
                      });
                    },
            ...
            if (
              ...
              (e.sel = new At(
                Ne(e.sel.ranges, function (i) {
                  return new Ae(k(i.anchor.line + t, i.anchor.ch), k(i.head.line + t, i.head.ch));
                }),
                e.sel.primIndex
              )),
              e.cm)
          ...
          function zs(e, t, n) {
            ...
            e.options.lineWrapping ||
              ...
              e.options.lineWrapping ||
                (r.iter(s, o.line + t.text.length, function (y) {
                  var S = Gn(y);
                  S > i.maxLineLength &&
                    ((i.maxLine = y), (i.maxLineLength = S), (i.maxLineChanged = !0), (a = !1));
                }),
            ...
            t.full
              ? bt(e)
              : o.line == l.line && t.text.length == 1 && !yl(e.doc, t)
              ? ur(e, o.line, 'text')
              : bt(e, o.line, l.line + 1, u);
            var d = Lt(e, 'changes'),
              p = Lt(e, 'change');
            if (p || d) {
              var m = { from: o, to: l, text: t.text, removed: t.removed, origin: t.origin };
              p && tt(e, 'change', e, m),
          ...
          function Fl(e, t, n, r) {
            for (var i = 0; i < e.length; ++i) {
              ...
              for (var s = 0; s < o.changes.length; ++s) {
                var u = o.changes[s];
                if (n < u.from.line)
                  (u.from = k(u.from.line + r, u.from.ch)), (u.to = k(u.to.line + r, u.to.ch));
                else if (t <= u.to.line) {
                  l = !1;
                  break;
                }
          ...
          function Tn(e, t, n, r) {
            var i = t,
              o = t;
            return (
              typeof t == 'number' ? (o = U(e, po(e, t))) : (i = f(t)),
          ...
          Ln.prototype = {
            ...
            removeInner: function (e, t) {
              for (var n = e, r = e + t; n < r; ++n) {
                var i = this.lines[n];
                (this.height -= i.height), Pa(i), tt(i, 'delete');
              }
          ...
          (Nn.prototype.clear = function () {
            ...
            (Nn.prototype.changed = function () {
              ...
              i &&
                ...
                n &&
                  Mt(n, function () {
                    (n.curOp.forceUpdate = !0), _l(n, r, i), tt(n, 'lineWidgetChanged', n, e, f(r));
                  }));
            }),
            Et(Nn);
          function _l(e, t, n) {
            ...
            return (
              ...
              Tn(e, t, 'widget', function (l) {
                ...
                if (
                  ...
                  Dt(l, l.height + pn(i)), s && Ki(o, i.height), (o.curOp.forceUpdate = !0);
                }
                return !0;
              }),
          ...
          (pr.prototype.clear = function () {
            if (!this.explicitlyCleared) {
              ...
              for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                e && !this.collapsed
                  ...
                  a.from == null && this.collapsed && !sr(this.doc, l) && e && Dt(l, Ur(e.display));
              }
              ...
              r != null && e && this.collapsed && bt(e, r, i + 1),
                ...
                this.atomic && this.doc.cantEdit && ((this.doc.cantEdit = !1), e && Nl(e.doc)),
            ...
            (pr.prototype.find = function (e, t) {
              ...
              for (var n, r, i = 0; i < this.lines.length; ++i) {
                ...
                if (l.from != null && ((n = k(t ? o : f(o), l.from)), e == -1)) return n;
            ...
            (pr.prototype.attachLine = function (e) {
              if (!this.lines.length && this.doc.cm) {
                ...
                (!t.maybeHiddenMarkers || q(t.maybeHiddenMarkers, this) == -1) &&
          ...
          function Vr(e, t, n, r, i) {
            if (r && r.shared) return Es(e, t, n, r, i);
            if (e.cm && !e.cm.curOp) return rt(e.cm, Vr)(e, t, n, r, i);
            var o = new pr(e, i),
              l = I(t, n);
            if ((r && de(r, o, !1), l > 0 || (l == 0 && o.clearWhenEmpty !== !1))) return o;
            if (
              (o.replacedWith &&
                ((o.collapsed = !0),
              ...
              if (Do(e, t.line, t, n, o) || (t.line != n.line && Do(e, n.line, t, n, o)))
            ...
            if (
              ...
              o.atomic && Nl(s.doc), tt(s, 'markerAdded', s, o);
            }
            return o;
          }
          var Dn = function (e, t) {
          ...
          function Es(e, t, n, r, i) {
            ...
            return (
              hr(e, function (s) {
                a && (r.widgetNode = a.cloneNode(!0)), o.push(Vr(s, fe(s, t), fe(s, n), r, i));
          ...
          function Bl(e) {
            return e.findMarks(k(e.first, 0), e.clipPos(k(e.lastLine())), function (t) {
              return t.parent;
            });
          }
          function Is(e, t) {
            ...
            for (
              var t = function (r) {
                  ...
                  for (var l = 0; l < i.markers.length; l++) {
                    var a = i.markers[l];
                    q(o, a.doc) == -1 && ((a.parent = null), i.markers.splice(l--, 1));
                  }
                },
                n = 0;
              n < e.length;
          ...
          (xt.prototype = C(Mn.prototype, {
            ...
            setCursor: nt(function (e, t, n) {
              Tl(this, fe(this, typeof e == 'number' ? k(e, t || 0) : e), null, n);
            }),
            setSelection: nt(function (e, t, n) {
              Tl(this, fe(this, e), fe(this, t || e), n);
            }),
            ...
            setSelections: nt(function (e, t, n) {
              if (e.length) {
                for (var r = [], i = 0; i < e.length; i++)
                  r[i] = new Ae(fe(this, e[i].anchor), fe(this, e[i].head || e[i].anchor));
            ...
            replaceSelections: nt(function (e, t, n) {
              ...
              for (var a = t && t != 'end' && Cs(this, r, t), s = r.length - 1; s >= 0; s--)
                Jr(this, r[s]);
              a ? Ll(this, a) : this.cm && jr(this.cm);
            }),
            undo: nt(function () {
              si(this, 'undo');
            }),
            ...
            unlinkDoc: function (e) {
              if ((e instanceof Be && (e = e.doc), this.linked))
                for (var t = 0; t < this.linked.length; ++t) {
                  var n = this.linked[t];
                  if (n.doc == e) {
                    this.linked.splice(t, 1), e.unlinkDoc(this), Fs(Bl(this));
                    break;
                  }
                }
...
`
                      ...
                      a = function () {
                        ++l == i &&
                          rt(t, function () {
                            ...
                            Jr(t.doc, y), Ll(t.doc, cr(fe(t.doc, n), fe(t.doc, dr(y))));
                          })();
                      },
                      s = function (y, S) {
                        if (
                          t.options.allowDropFileTypes &&
                          q(t.options.allowDropFileTypes, y.type) == -1
                        ) {
                          a();
                          return;
                        }
          ...
          function Hs(e, t) {
            if (M && (!e.state.draggingText || +new Date() - Rl < 100)) {
              ir(t);
              return;
            }
            if (
              !(Ge(e, t) || Vt(e.display, t)) &&
          ...
          function Gs(e) {
            ...
            for (var n in e)
              if (e.hasOwnProperty(n)) {
                ...
                for (var i = Ne(n.split(' '), qs), o = 0; o < i.length; o++) {
                  var l = void 0,
                    a = void 0;
                  o == i.length - 1
                    ? ((a = i.join(' ')), (l = r))
          ...
          function Xl(e, t) {
            ...
            return n == null || e.altGraphKey
              ? !1
              : (e.keyCode == 3 && e.code && (n = e.code), jl(n, e, t));
          }
          function fi(e) {
          ...
          function js(e, t, n, r) {
            ...
            if (e.doc.direction == 'rtl' || l.level == 1) {
              var p = (l.level == 1) == r < 0,
                m = a(n, p ? 1 : -1);
              if (m != null && (p ? m <= l.to && m <= d.end : m >= l.from && m >= d.begin)) {
            ...
            var S = function (P, W, E) {
                for (
                  var B = function (Fe, it) {
                    return it ? new k(n.line, a(Fe, 1), 'before') : new k(n.line, Fe, 'after');
                  };
                  P >= 0 && P < i.length;
                  P += W
                ) {
          ...
          var zn = {
            ...
            deleteLine: function (e) {
              return en(e, function (t) {
                return { from: k(t.from().line, 0), to: fe(e.doc, k(t.to().line + 1, 0)) };
              });
            },
              ...
              return Mt(e, function () {
                for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++)
                  if (t[r].empty()) {
                    ...
                    if (o) {
                      if ((i.ch == o.length && (i = new k(i.line, i.ch - 1)), i.ch > 0))
...
`,
          ...
          function Vl(e) {
            ...
            if (
              ...
              ce &&
                ...
                n == 18 && !/\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) && Qs(t);
            }
          }
          function Qs(e) {
          ...
          function ea(e) {
            ...
            if (
              !(e.target && e.target != t.display.input.getField()) &&
              !(Vt(t.display, e) || Ge(t, e) || (e.ctrlKey && !e.altKey) || (xe && e.metaKey))
            ) {
              var n = e.keyCode,
                r = e.charCode;
              if (ce && n == no) {
              ...
              if (!(ce && (!e.which || e.which < 10) && Ql(t, e))) {
          ...
          io.prototype.compare = function (e, t, n) {
            return this.time + Vs > e && I(t, this.pos) == 0 && n == this.button;
          };
          var En, In;
          function $s(e, t) {
            var n = +new Date();
          ...
          function ru(e, t, n, r) {
            M ? setTimeout(te(rl, e), 0) : (e.curOp.focus = g(Re(e)));
            var i = tu(e, n, r),
              o = e.doc.sel,
              l;
            e.options.dragDrop &&
          ...
          function iu(e, t, n, r) {
            ...
            r.addNew
              ? a == -1
                ? ((a = u.length), ct(o, Rt(e, u.concat([l]), a), { scroll: !1, origin: '*mouse' }))
                ...
                if (((p = E), r.unit == 'rectangle')) {
                  for (
                    ...
                    Fe == it
                      ...
                      : wt.length > Ze && B.push(new Ae(k(Ue, Ze), k(Ue, Ke(wt, it, Q))));
                  }
                  ...
                  (Xe[a] = ou(e, new Ae(fe(o, $e), Je))), ct(o, Rt(e, Xe, a), gt);
                }
            }
          ...
          function na(e, t, n, r) {
            ...
            for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
              ...
              if (u && u.getBoundingClientRect().right >= i) {
                ...
                return qe(e, n, e, d, p.className, t), yt(t);
              }
            }
          }
          function oo(e, t) {
          ...
          function lu(e, t) {
            return Lt(e, 'gutterContextMenu') ? na(e, t, 'gutterContextMenu', !1) : !1;
          }
          function oa(e) {
          ...
          function au(e) {
            ...
            (e.defineOption = n),
              ...
              n('readOnly', !1, function (r, i) {
                i == 'nocursor' && (Gr(r), r.display.input.blur()),
          ...
          function Be(e, t) {
            ...
            (this.options = t = t ? de(t) : {}), de(la, t, !1);
            var r = t.value;
            typeof r == 'string'
          ...
          (Be.defaults = la), (Be.optionHandlers = di);
          function fu(e) {
            var t = e.display;
            J(t.scroller, 'mousedown', rt(e, ta)),
              M && j < 11
                ? J(
                    t.scroller,
                    'dblclick',
            ...
            J(t.scroller, 'touchstart', function (s) {
              ...
              J(t.scroller, 'touchend', function (s) {
                var u = t.activeTouch;
                if (u && !Vt(t, s) && u.left != null && !u.moved && new Date() - u.start < 300) {
          ...
          function Fn(e, t, n, r) {
            ...
            if (!r && !/\S/.test(a.text)) (d = 0), (n = 'not');
              ...
              n == 'smart' &&
              ((d = i.mode.indent(o, a.text.slice(u.length), a.text)), d == Ct || d > 150)
            ) {
              if (!r) return;
              n = 'prev';
            }
            ...
            if ((m < d && (p += ht(d - m)), p != u))
              return Qr(i, p, k(t, 0), k(t, u.length), '+input'), (a.stateAfter = null), !0;
...
`) == t
                ...
                if (r.ranges.length % Kt.text.length == 0) {
                  u = [];
                  for (var d = 0; d < Kt.text.length; d++) u.push(o.splitLines(Kt.text[d]));
                }
              } else
            ...
            for (var p = e.curOp.updateInput, m = r.ranges.length - 1; m >= 0; m--) {
              ...
              y.empty() &&
                (n && n > 0
                  ? (S = k(S.line, S.ch - n))
                  : e.state.overwrite && !a
                  ? (N = k(N.line, Math.min(U(o, N.line).text.length, N.ch + re(s).length)))
                  : a &&
                    Kt &&
                    Kt.lineWise &&
                    Kt.text.join(`
...
`) &&
              ...
              for (var n = e.doc.sel, r = n.ranges.length - 1; r >= 0; r--) {
                ...
                if (!(i.head.ch > 100 || (r && n.ranges[r - 1].head.line == i.head.line))) {
                  ...
                  if (o.electricChars) {
                    ...
                    o.electricInput &&
                      o.electricInput.test(U(e.doc, i.head.line).text.slice(0, i.head.ch)) &&
                      (l = Fn(e, i.head.line, 'smart'));
          ...
          function cu(e) {
            ...
            (e.prototype = {
              ...
              getLineTokens: function (r, i) {
                return xo(this, k(r), i, !0);
              },
              getTokenTypeAt: function (r) {
                r = fe(this.doc, r);
                var i = yo(this, U(this.doc, r.line)),
                  o = 0,
                  l = (i.length - 1) / 2,
                  a = r.ch,
                  s;
              ...
              getHelpers: function (r, i) {
                ...
                for (var d = 0; d < l._global.length; d++) {
                  var p = l._global[d];
                  p.pred(a, this) && q(o, p.val) == -1 && o.push(p.val);
                }
                return o;
              },
              ...
              coordsChar: function (r, i) {
                return (r = Zo(this, r, i || 'page')), zi(this, r.left, r.top);
              },
              ...
              addWidget: function (r, i, o, l, a) {
                ...
                (i.style.top = u + 'px'),
                  ...
                  a == 'right'
                    ...
                    : (a == 'left'
                        ? (d = 0)
                        : a == 'middle' && (d = (s.sizer.clientWidth - i.offsetWidth) / 2),
                      (i.style.left = d + 'px')),
                  o &&
                    ss(this, {
                      left: d,
              ...
              triggerOnKeyDown: pt(Vl),
              triggerOnKeyPress: pt(ea),
              triggerOnKeyUp: $l,
              triggerOnMouseDown: pt(ta),
              ...
              moveV: pt(function (r, i) {
                ...
                if (
                  (l.extendSelectionsBy(function (d) {
                    ...
                    var m = ca(o, p, r, i);
                    return (
                      i == 'page' && d == l.sel.primary() && Ki(o, Zn(o, m, 'div').top - p.top), m
                    );
                  }, Le),
                  a.length)
                )
              ...
              toggleOverwrite: function (r) {
                (r != null && r == this.state.overwrite) ||
                  ...
                  qe(this, 'overwriteToggle', this, this.state.overwrite));
              },
              hasFocus: function () {
              ...
              scrollIntoView: pt(function (r, i) {
                r == null
                  ...
                  r.to || (r.to = r.from),
                  (r.margin = i || 0),
                  r.from.line != null ? us(this, r) : il(this, r.from, r.to, r.margin);
              }),
              setSize: pt(function (r, i) {
                ...
                r != null && (this.display.wrapper.style.width = l(r)),
                  ...
                  this.options.lineWrapping && jo(this);
          ...
          function uo(e, t, n, r, i) {
            ...
            function d(W) {
              ...
              } else i ? (E = js(e.cm, a, t, n)) : (E = to(a, t, n));
              if (E == null)
            ...
            if (r == 'char' || r == 'codepoint') d();
              ...
              for (
                var p = null, m = r == 'group', y = e.cm && e.cm.getHelper(t, 'wordChars'), S = !0;
                !(n < 0 && !d(!S));
                S = !1
              ) {
                var N =
...
`
          ...
          (Pe.prototype.init = function (e) {
            var t = this,
              ...
              i = (n.div = e.lineDiv);
            (i.contentEditable = !0),
              so(i, r.options.spellcheck, r.options.autocorrect, r.options.autocapitalize);
            function o(a) {
...
`));
            ...
            (Pe.prototype.showPrimarySelection = function () {
              ...
              if (!(o && !o.bad && l && !l.bad && I(Hr(o, l), r) == 0 && I(mt(o, l), i) == 0)) {
                ...
                y &&
                  ...
                  m && e.anchorNode == null ? e.addRange(m) : Se && this.startGracePeriod()),
            ...
            (Pe.prototype.pollSelection = function () {
              if (!(this.readDOMTimeout != null || this.gracePeriod || !this.selectionChanged())) {
                var e = this.getSelection(),
                  t = this.cm;
                if (V && G && this.cm.display.gutterSpecs.length && du(e.anchorNode)) {
                ...
                if (!this.composing) {
                  ...
                  n &&
                    r &&
                    Mt(t, function () {
                      ct(t.doc, cr(n, r), st), (n.bad || r.bad) && (t.curOp.selectionChanged = !0);
                    });
                }
              }
            }),
            (Pe.prototype.pollContent = function () {
              ...
              if (
                (s == t.view.length - 1
                  ...
                  : ((u = f(t.view[s + 1].line) - 1), (d = t.view[s + 1].node.previousSibling)),
                !a)
              )
                return !1;
              for (
                var p = e.doc.splitLines(hu(e, a, d, l, u)),
              ...
              for (
                var y = 0, S = 0, N = p[0], z = m[0], P = Math.min(N.length, z.length);
              ...
              for (
                ...
                S < B && W.charCodeAt(W.length - S - 1) == E.charCodeAt(E.length - S - 1);
              ...
              if (p.length == 1 && m.length == 1 && l == r.line)
                for (
                  ;
                  y && y > r.ch && W.charCodeAt(W.length - S - 1) == E.charCodeAt(E.length - S - 1);
              ...
              if (p.length > 1 || p[0] || I(Q, Z)) return Qr(e.doc, p, Q, Z, '+input'), !0;
            }),
            ...
            function m(y) {
              if (y.nodeType == 1) {
                ...
                if (N) {
                  ...
                  P.length && (z = P[0].find(0)) && p(Zt(e.doc, z.from, z.to).join(a));
                  return;
                }
          ...
          function pu(e, t, n) {
            ...
            var p = d(l, a, n);
            if (p) return rn(p, i);
            for (var m = a.nextSibling, y = l ? l.nodeValue.length - n : 0; m; m = m.nextSibling) {
            ...
            for (var S = a.previousSibling, N = n; S; S = S.previousSibling) {
              if (((p = d(S, S.firstChild, -1)), p)) return rn(k(p.line, p.ch + N), i);
          ...
          (Ye.prototype.init = function (e) {
            ...
            e.wrapper.insertBefore(this.wrapper, e.wrapper.firstChild),
              ...
              J(i, 'paste', function (l) {
                Ge(r, l) || aa(l, r) || ((r.state.pasteIncoming = +new Date()), n.fastPoll());
              });
            function o(l) {
              if (!Ge(r, l)) {
...
`)),
            ...
            (Ye.prototype.poll = function () {
              ...
              return (
                Mt(t, function () {
                  ao(t, i.slice(l), r.length - l, null, e.composing ? '*compose' : null),
                    i.length > 1e3 ||
                    i.indexOf(`
`) > -1
                      ? (n.value = e.prevInput = '')
      ...
      outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);`);
          ...
          au(Be), cu(Be);
          var yu = 'iter insert remove copy getEditor constructor'.split(' ');
          ...
          return (
            ...
            (Be.defineMode = function (e) {
              !Be.defaults.mode && e != 'null' && (Be.defaults.mode = e), _t.apply(this, arguments);
            }),
            (Be.defineMIME = br),
  ...
  (function (F) {
    ...
    F.defineMode('css', function (ee, X) {
      ...
      function Ve(w, A) {
        ...
        if (C == '@') return w.eatWhile(/[\w\\\-]/), q('def', w.current());
        if (C == '=' || ((C == '~' || C == '|') && w.eat('='))) return q(null, 'compare');
        if (C == '"' || C == "'") return (A.tokenize = Ct(C)), A.tokenize(w, A);
        if (C == '#') return w.eatWhile(/[\w\\\-]/), q('atom', 'hash');
        if (C == '!') return w.match(/^\s*\w*/), q('keyword', 'important');
        if (/\d/.test(C) || (C == '.' && w.eat(/\d/)))
          return w.eatWhile(/[\w.%]/), q('number', 'unit');
        if (C === '-') {
          if (/[\d.]/.test(w.peek())) return w.eatWhile(/[\w.%]/), q('number', 'unit');
          if (w.match(/^-[\w\\\-]*/))
            return (
              w.eatWhile(/[\w\\\-]/),
              w.match(/^\s*:/, !1)
                ? q('variable-2', 'variable-definition')
                : q('variable-2', 'variable')
            );
          if (w.match(/^\w+-/)) return q('meta', 'meta');
        } else return /[,+>*\/]/.test(C) ? q(null, 'select-op') : C == '.' && w.match(/^-?[_a-z][_a-z0-9-]*/i) ? q('qualifier', 'qualifier') : /[:;{}\[\]\(\)]/.test(C) ? q(null, C) : w.match(/^[\w-.]+(?=\()/) ? (/^(url(-prefix)?|domain|regexp)$/i.test(w.current()) && (A.tokenize = st), q('variable callee', 'variable')) : /[\w\\\-]/.test(C) ? (w.eatWhile(/[\w\\\-]/), q('property', 'word')) : q(null, null);
      }
      function Ct(w) {
        return function (A, C) {
          ...
          return (R == w || (!be && w != ')')) && (C.tokenize = null), q('string', 'string');
        };
      }
      function st(w, A) {
        return (
          w.next(),
          w.match(/^\s*[\"\')]/, !1) ? (A.tokenize = null) : (A.tokenize = Ct(')')),
          q(null, '(')
        );
      }
      function gt(w, A, C) {
      ...
      function Le(w, A, C, be) {
        return (w.context = new gt(C, A.indentation() + (be === !1 ? 0 : T), w.context)), C;
      }
      function Ke(w) {
      ...
      return (
        (Ne.top = function (w, A, C) {
          ...
          if (/^@(media|supports|(-moz-)?document|import)$/i.test(w)) return Le(C, A, 'atBlock');
        ...
        (Ne.block = function (w, A, C) {
          if (w == 'word') {
            ...
            return g.hasOwnProperty(be)
              ...
              : ze
              ? ((ue = A.match(/^\s*:(?:\s|$)/, !1) ? 'property' : 'tag'), 'block')
              : ((ue += ' error'), 'maybeprop');
          } else
            return w == 'meta'
              ? 'block'
        ...
        (Ne.prop = function (w, A, C) {
          ...
          if (
            w == 'hash' &&
            !/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(A.current())
          )
            ue += ' error';
          else if (w == 'word') re(A);
        ...
        (Ne.propBlock = function (w, A, C) {
          return w == '}' ? Ke(C) : w == 'word' ? ((ue = 'property'), 'maybeprop') : C.context.type;
        }),
        ...
        (Ne.atBlock_parens = function (w, A, C) {
          return w == ')' ? Ke(C) : w == '{' || w == '}' ? ht(w, A, C, 2) : Ne.atBlock(w, A, C);
        }),
        ...
        (Ne.restricted_atBlock = function (w, A, C) {
          return w == '}'
            ...
            : w == 'word'
            ? ((C.stateArg == '@font-face' && !K.hasOwnProperty(A.current().toLowerCase())) ||
              (C.stateArg == '@counter-style' && !$.hasOwnProperty(A.current().toLowerCase()))
                ? (ue = 'error')
                : (ue = 'property'),
              'maybeprop')
            : 'restricted_atBlock';
        ...
        (Ne.at = function (w, A, C) {
          return w == ';'
            ...
            : w == '{' || w == '}'
            ? ht(w, A, C)
            : (w == 'word' ? (ue = 'tag') : w == 'hash' && (ue = 'builtin'), 'at');
        }),
            ...
            return (
              ...
              C.prev &&
                ...
                (C.type == 'block' ||
                  ...
                  ? ((C = C.prev), (R = C.indent))
                  : ((be == ')' && (C.type == 'parens' || C.type == 'atBlock_parens')) ||
    ...
    function Ee(ee) {
      for (var X = {}, me = 0; me < ee.length; ++me) X[ee[me].toLowerCase()] = !0;
      return X;
    }
    var Se = ['domain', 'regexp', 'url', 'url-prefix'],
      ...
      ye = Ee(_e),
      Me = Se.concat(Qe).concat(M).concat(_).concat(G).concat(ce).concat(oe).concat(_e);
        ...
        (function (F) {
          ...
          F.defineMode('xml', function (We, Qe) {
              ...
              if (v == '<')
                return c.eat('!')
                  ? c.eat('[')
                    ...
                    : null
                  : c.eat('?')
                  ? (c.eatWhile(/[\w\._\-]/), (x.tokenize = Te('meta', '?>')), 'meta')
                  : ((ie = c.eat('/') ? 'closeTag' : 'openTag'), (x.tokenize = ce), 'tag bracket');
              if (v == '&') {
                var g;
                return (
                  c.eat('#')
            ...
            function ce(c, x) {
              ...
              if (b == '>' || (b == '/' && c.eat('>')))
                return (
                  (x.tokenize = se), (ie = b == '>' ? 'endTag' : 'selfcloseTag'), 'tag bracket'
                );
              if (b == '=') return (ie = 'equals'), null;
              if (b == '<') {
                (x.tokenize = se), (x.state = _e), (x.tagName = x.tagStart = null);
                var v = x.tokenize(c, x);
                return v ? v + ' tag error' : 'tag error';
              } else return /[\'\"]/.test(b) ? ((x.tokenize = Ie(b)), (x.stringStartCol = c.column()), x.tokenize(c, x)) : (c.match(/^[^\s\u00a0=<>\"\']*[^\s\u00a0=<>\"\'\/]/), 'word');
            }
            function Ie(c) {
              var x = function (b, v) {
                for (; !b.eol(); )
            ...
            function Oe(c) {
              return function (x, b) {
                for (var v; (v = x.next()) != null; ) {
                  if (v == '<') return (b.tokenize = Oe(c + 1)), b.tokenize(x, b);
                  if (v == '>')
                    if (c == 1) {
                      b.tokenize = se;
                      break;
            ...
            function V(c, x, b) {
              (this.prev = c.context),
                ...
                (this.startOfLine = b),
                (M.doNotIndent.hasOwnProperty(x) || (c.context && c.context.noIndent)) &&
                  (this.noIndent = !0);
            }
            function oe(c) {
            ...
            function _e(c, x, b) {
              return c == 'openTag' ? ((b.tagStart = x.column()), ye) : c == 'closeTag' ? Me : _e;
            }
            function ye(c, x, b) {
              return c == 'word'
                ? ((b.tagName = x.current()), (G = 'tag'), X)
                : M.allowMissingTagName && c == 'endTag'
                ? ((G = 'tag bracket'), X(c, x, b))
                : ((G = 'error'), ye);
            }
            function Me(c, x, b) {
              if (c == 'word') {
              ...
              } else return M.allowMissingTagName && c == 'endTag' ? ((G = 'tag bracket'), He(c, x, b)) : ((G = 'error'), ee);
            }
            function He(c, x, b) {
              return c != 'endTag' ? ((G = 'error'), He) : (oe(b), _e);
            }
            function ee(c, x, b) {
              return (G = 'error'), He(c, x, b);
            }
            function X(c, x, b) {
            ...
            function me(c, x, b) {
              return c == 'equals' ? T : (M.allowMissing || (G = 'error'), X(c, x, b));
            }
            function T(c, x, b) {
              return c == 'string'
                ? H
            ...
            return {
              ...
              token: function (c, x) {
                if ((!x.tagName && c.sol() && (x.indented = c.indentation()), c.eatSpace()))
                  return null;
                ie = null;
              ...
              indent: function (c, x, b) {
                ...
                if (c.tokenize.isInAttribute)
                  return c.tagStart == c.indented ? c.stringStartCol + 1 : c.indented + Ce;
                ...
                if (g && g[1])
                  for (; v; )
                    if (v.tagName == g[2]) {
                      v = v.prev;
                      break;
                    } else if (M.implicitlyClosed.hasOwnProperty(ae(v.tagName))) v = v.prev;
                    else break;
                else if (g)
                  for (; v; ) {
              ...
              xmlCurrentContext: function (c) {
                for (var x = [], b = c.context; b; b = b.prev) x.push(b.tagName);
                return x.reverse();
              },
            };
          }),
      ...
      (function (yr, Or) {
        (function (F) {
          ...
          F.defineMode('javascript', function (Ee, Se) {
            ...
            function V(f, h) {
              var L = f.next();
              if (L == '"' || L == "'") return (h.tokenize = oe(L)), h.tokenize(f, h);
              ...
              if (L == '/')
                return f.eat('*')
                  ...
                  : Dt(f, h, 1)
                  ? (Ie(f), f.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), ae('regexp', 'string-2'))
                  : (f.eat('='), ae('operator', 'operator', f.current()));
              if (L == '`') return (h.tokenize = _e), _e(f, h);
              if (L == '#' && f.peek() == '!') return f.skipToEnd(), ae('meta', 'meta');
              if (L == '#' && f.eatWhile(ie)) return ae('variable', 'property');
              if (
                (L == '<' && f.match('!--')) ||
                (L == '-' && f.match('->') && !/\S/.test(f.string.slice(0, f.start)))
              )
              ...
              if (se.test(L))
                return (
                  (L != '>' || !h.lexical || h.lexical.type != '>') &&
                    (f.eat('=')
                      ? (L == '!' || L == '=') && f.eat('=')
                      : /[<>*+\-|&?]/.test(L) && (f.eat(L), L == '>' && f.eat(L))),
                  L == '?' && f.eat('.') ? ae('.') : ae('operator', 'operator', f.current())
                );
              if (ie.test(L)) {
                f.eatWhile(ie);
                var O = f.current();
                if (h.lastType != '.') {
                  if (G.propertyIsEnumerable(O)) {
                    var k = G[O];
                    return ae(k.type, k.style, O);
                  }
                  if (O == 'async' && f.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1))
            ...
            function X(f, h) {
              if (!j) return !1;
              for (var L = f.localVars; L; L = L.next) if (L.name == h) return !0;
            ...
            function me(f, h, L, O, k) {
              ...
              for (
                ...
                var De = I.length ? I.pop() : M ? q : he;
                if (De(L, O)) {
                  for (; I.length && I[I.length - 1].lex; ) I.pop()();
                  return T.marked ? T.marked : L == 'variable' && X(f, O) ? 'variable-2' : h;
                }
              }
            }
            var T = { state: null, column: null, marked: null, cc: null };
            function H() {
              for (var f = arguments.length - 1; f >= 0; f--) T.cc.push(arguments[f]);
            }
            function c() {
            ...
            function b(f) {
              ...
              if (((T.marked = 'def'), !!j)) {
                ...
                Se.globalVars && !x(f, h.globalVars) && (h.globalVars = new K(f, h.globalVars));
              }
            }
            function v(f, h) {
              if (h)
                ...
                } else return x(f, h.vars) ? h : new D(h.prev, new K(f, h.vars), !1);
              else return null;
            }
            function g(f) {
              return (
            ...
            function le(f, h) {
              var L = function () {
                ...
                if (O.lexical.type == 'stat') k = O.lexical.indented;
                  ...
                  for (var I = O.lexical; I && I.type == ')' && I.align; I = I.prev) k = I.indented;
            ...
            function he(f, h) {
              return f == 'var'
                ...
                ? ((T.marked = 'keyword'), c(le('form', f == 'class' ? f : h), Er, te))
                : f == 'variable'
                ? _ && h == 'declare'
                  ...
                  ? ((T.marked = 'keyword'),
                    h == 'enum'
                      ? c(U)
                      : h == 'type'
                      ? c(Hn, de('operator'), ke, de(';'))
                      : c(le('form'), yt, de('{'), le('}'), Ot, te, te))
                  : _ && h == 'namespace'
                  ? ((T.marked = 'keyword'), c(le('form'), q, he, te))
                  : _ && h == 'abstract'
                  ? ((T.marked = 'keyword'), c(he))
                  : c(le('stat'), be)
                : f == 'switch'
                ? c(le('form'), Ct, de('{'), le('}', 'switch'), Re, Ot, te, te, ze)
                : f == 'case'
                ? c(q, de(':'))
                : f == 'default'
                ? c(de(':'))
                : f == 'catch'
                ? c(le('form'), pe, ue, he, te, ze)
                : f == 'export'
                ? c(le('stat'), Ir, te)
                : f == 'import'
                ? c(le('stat'), ar, te)
            ...
            function st(f, h, L) {
              if (T.state.fatArrowAt == T.stream.start) {
                var O = L ? Ne : re;
                if (f == '(') return c(pe, le(')'), ve(Ft, ')'), te, de('=>'), O, ze);
            ...
            function lt(f, h) {
              return f != 'quasi' ? H() : h.slice(h.length - 2) != '${' ? c(lt) : c(gt, ht);
            }
            function ht(f) {
              if (f == '}') return (T.marked = 'string-2'), (T.state.tokenize = _e), c(lt);
            }
            function re(f) {
              return Me(T.stream, T.state), H(f == '{' ? he : q);
            }
            function Ne(f) {
            ...
            function ne(f, h) {
              ...
              if (f == 'variable' || T.style == 'keyword') {
                if (((T.marked = 'property'), h == 'get' || h == 'set')) return c(Y);
                var L;
                return (
                  _ &&
                ...
                if (f == 'number' || f == 'string')
                  return (T.marked = Ce ? 'property' : T.style + ' property'), c(we);
                if (f == 'jsonld-keyword') return c(we);
                if (_ && g(h)) return (T.marked = 'keyword'), c(ne);
                if (f == '[') return c(q, rr, de(']'), we);
            ...
            function ve(f, h, L) {
              function O(k, I) {
                ...
                return k == h || I == h ? c() : L && L.indexOf(';') > -1 ? H(f) : c(de(h));
              }
              return function (k, I) {
            ...
            function Tt(f, h, L) {
              for (var O = 3; O < arguments.length; O++) T.cc.push(arguments[O]);
            ...
            function nr(f) {
              if (_ && f == ':') return T.stream.match(/^\s*\w+\s+is\b/, !1) ? c(q, gi, ke) : c(ke);
            }
            function gi(f, h) {
            ...
            function J(f) {
              return f.match(/[\}\)\]]/) ? c() : f == ',' || f == ';' ? c(J) : H(Yt, J);
            }
            function Yt(f, h) {
              if (f == 'variable' || T.style == 'keyword') return (T.marked = 'property'), c(Yt);
            ...
            function ut(f, h) {
              return f != 'quasi' ? H() : h.slice(h.length - 2) != '${' ? c(ut) : c(ke, qe);
            }
            function qe(f) {
              if (f == '}') return (T.marked = 'string-2'), (T.state.tokenize = _e), c(ut);
            }
            function Ge(f, h) {
              return (f == 'variable' && T.stream.match(/^\s*[?:]/, !1)) || h == '?'
                ? c(Ge)
                : f == ':'
                ? c(ke)
                : f == 'spread'
            ...
            function zt(f, h) {
              ...
              if (h == 'extends' || h == 'implements') return (T.marked = 'keyword'), c(ke);
            ...
            function zr(f, h) {
              return h == 'enum' ? ((T.marked = 'keyword'), c(U)) : H(yt, rr, It, yi);
            }
            function yt(f, h) {
            ...
            function Pr(f, h) {
              if (f == 'keyword b' && h == 'else') return c(le('form', 'else'), he, te);
            }
            function _n(f, h) {
            ...
            function Hn(f, h) {
              if (f == 'keyword' || f == 'variable') return (T.marked = 'type'), c(Hn);
            ...
            function Wt(f, h) {
              ...
              if (h == 'extends' || h == 'implements' || (_ && f == ','))
                return h == 'implements' && (T.marked = 'keyword'), c(_ ? ke : q, Wt);
            ...
            function ar(f) {
              return f == 'string' ? c() : f == '(' ? H(q) : f == '.' ? H(Le) : H(Wr, Ut, _r);
            }
            function Wr(f, h) {
              return f == '{'
                ? Tt(Wr, '}')
                : (f == 'variable' && b(h), h == '*' && (T.marked = 'keyword'), c(sn));
            }
            function Ut(f) {
              if (f == ',') return c(Wr, Ut);
            }
            ...
            function _r(f, h) {
              if (h == 'from') return (T.marked = 'keyword'), c(q);
            }
            function je(f) {
              return f == ']' ? c() : H(ve(Ve, ']'));
            }
            ...
            function Dt(f, h, L) {
              return (
                ...
                (h.lastType == 'quasi' && /\{\s*$/.test(f.string.slice(0, f.pos - (L || 0))))
              );
            }
            return {
              ...
              token: function (f, h) {
                ...
                return Te == 'comment'
                  ? L
                  : ((h.lastType = Te == 'operator' && (Oe == '++' || Oe == '--') ? 'incdec' : Te),
                    me(h, L, Te, Oe, f));
              },
              indent: function (f, h) {
                ...
                return et == 'vardef'
                  ? O.indented +
                      (f.lastType == 'operator' || f.lastType == ',' ? O.info.length + 1 : 0)
                  : et == 'form' && L == '{'
                  ? O.indented
                  : et == 'form'
                  ? O.indented + We
                  ...
                  : O.info == 'switch' && !mt && Se.doubleIndentSwitch != !1
                  ? O.indented + (/^(?:case|default)\b/.test(h) ? We : 2 * We)
                  : O.align
                  ? O.column + (mt ? 0 : 1)
                  : O.indented + (mt ? 0 : We);
              },
            ...
            F.defineMIME('application/x-json', { name: 'javascript', json: !0 }),
            F.defineMIME('application/manifest+json', { name: 'javascript', json: !0 }),
            F.defineMIME('application/ld+json', { name: 'javascript', jsonld: !0 }),
            F.defineMIME('text/typescript', { name: 'javascript', typescript: !0 }),
            F.defineMIME('application/typescript', { name: 'javascript', typescript: !0 });
        });
      })()),
    ga.exports
  );
...
(function (yr, Or) {
  (function (F) {
    ...
    function Se(ie, G, se) {
      ...
      return (
        Ie > -1
          ...
          : ce.match(/<\/?$/) && (ie.backUp(ce.length), ie.match(G, !1) || ie.match(ce)),
        se
      );
    }
    var We = {};
    function Qe(ie) {
      var G = We[ie];
      return G || (We[ie] = new RegExp('\\s+' + ie + `\\s*=\\s*('|")?([^'"]+)('|")?\\s*`));
    }
    function Ce(ie, G) {
      var se = ie.match(Qe(G));
      return se ? /^\s*(.*?)\s*$/.exec(se[2])[1] : '';
    }
    function M(ie, G) {
      return new RegExp((G ? '^' : '') + '</\\s*' + ie + '\\s*>', 'i');
    }
    function j(ie, G) {
      for (var se in ie)
        for (var ce = G[se] || (G[se] = []), Ie = ie[se], Te = Ie.length - 1; Te >= 0; Te--)
          ce.unshift(Ie[Te]);
    }
    function _(ie, G) {
        ...
        function ae(V, oe) {
          ...
          if (
            ...
            (oe.token = function (T, H) {
              ...
              (oe.localMode = ee),
              (oe.localState = F.startState(ee, se.indent(oe.htmlState, '', '')));
          } else oe.inTag && ((oe.inTag += V.current()), V.eol() && (oe.inTag += ' '));
          return xe;
        }
        return {
          startState: function () {
            var V = F.startState(se);
            return { token: ae, inTag: null, localMode: null, localState: null, htmlState: V };
          },
          ...
          innerMode: function (V) {
            return { state: V.localState || V.htmlState, mode: V.localMode || se };
          },
        };
      },
      'xml',
...
(function (yr, Or) {
  (function (F) {
    ...
    F.registerHelper('hintWords', 'python', We.concat(Qe).concat(['exec', 'print']));
    function Ce(j) {
    ...
    F.defineMode('python', function (j, _) {
      for (
        var ie = 'error',
          G = _.delimiters || _.singleDelimiters || /^[\(\)\[\]\{\}@,:`=;\.\\]/,
          se = [
            _.singleOperators,
            _.doubleOperators,
            _.doubleDelimiters,
      ...
      if (ae) {
        ...
        var oe = new RegExp(`^(([rbuf]|(br)|(rb)|(fr)|(rf))?('{3}|"{3}|['"]))`, 'i');
      } else {
        var V = _.identifiers || /^[_A-Za-z][_A-Za-z0-9]*/;
      ...
      function ye(x, b) {
        ...
        if ((v && (b.indent = x.indentation()), v && Ce(b).type == 'py')) {
          ...
          if (x.eatSpace()) {
            var D = x.indentation();
            return D > g ? X(b) : D < g && T(x, b) && x.peek() != '#' && (b.errorToken = !0), null;
          } else {
            var K = Me(x, b);
      ...
      function Me(x, b, v) {
        ...
        for (var $ = 0; $ < se.length; $++) if (x.match(se[$])) return 'operator';
        return x.match(G)
          ? 'punctuation'
      ...
      function He(x, b) {
        for (; 'rubf'.indexOf(x.charAt(0).toLowerCase()) >= 0; ) x = x.substr(1);
        var v = x.length == 1,
          g = 'string';
        function D($) {
          return function (pe, Re) {
            ...
            return (
              ze == 'punctuation' &&
                (pe.current() == '{'
                  ? (Re.tokenize = D($ + 1))
                  : pe.current() == '}' && ($ > 1 ? (Re.tokenize = D($ - 1)) : (Re.tokenize = K))),
              ze
            );
          };
        }
        function K($, pe) {
          for (; !$.eol(); )
            if (($.eatWhile(/[^'"\{\}\\]/), $.eat('\\'))) {
              ...
              if ($.match('{{')) return g;
              if ($.match('{', !1))
                return (pe.tokenize = D(0)), $.current() ? g : pe.tokenize($, pe);
              if ($.match('}}')) return g;
              if ($.match('}')) return ie;
              $.eat(/['"]/);
            }
      ...
      function X(x) {
        ...
        x.scopes.push({ offset: Ce(x).offset + j.indentUnit, type: 'py', align: null });
      }
      function me(x, b, v) {
      ...
      function T(x, b) {
        for (var v = x.indentation(); b.scopes.length > 1 && Ce(b).offset > v; ) {
      ...
      function H(x, b) {
        ...
        var v = b.tokenize(x, b),
          g = x.current();
        if (b.beginningOfLine && g == '@') return x.match(V, !1) ? 'meta' : ae ? 'operator' : ie;
        if (
          (/\S/.test(g) && (b.beginningOfLine = !1),
          (v == 'variable' || v == 'builtin') && b.lastToken == 'meta' && (v = 'meta'),
          (g == 'pass' || g == 'return') && (b.dedent = !0),
          g == 'lambda' && (b.lambda = !0),
          g == ':' && !b.lambda && Ce(b).type == 'py' && x.match(/^\s*(?:#|$)/, !1) && X(b),
          g.length == 1 && !/string|comment/.test(v))
        ) {
          var D = '[({'.indexOf(g);
          if ((D != -1 && me(x, b, '])}'.slice(D, D + 1)), (D = '])}'.indexOf(g)), D != -1))
            if (Ce(b).type == g) b.indent = b.scopes.pop().offset - Ie;
            else return ie;
        }
        return (
          b.dedent && x.eol() && Ce(b).type == 'py' && b.scopes.length > 1 && b.scopes.pop(), v
        );
      }
      var c = {
        ...
        token: function (x, b) {
          ...
          return (
            g &&
              g != 'comment' &&
              (b.lastToken = g == 'keyword' || g == 'punctuation' ? x.current() : g),
        ...
        indent: function (x, b) {
          ...
          var v = Ce(x),
            g =
              v.type == b.charAt(0) ||
              (v.type == 'py' && !x.dedent && /^(else:|elif |except |finally:)/.test(b));
          return v.align != null ? v.align - (g ? 1 : 0) : v.offset - (g ? Ie : 0);
        },
...
(function (yr, Or) {
  (function (F) {
    ...
    function Se(v, g, D, K) {
      var $ = v.indented;
      return (
        v.context && v.context.type == 'statement' && D != 'statement' && ($ = v.context.indented),
    ...
    F.defineMode('clike', function (v, g) {
      var D = v.indentUnit,
        ...
        q = g.indentStatements !== !1,
        Ve = g.indentSwitch !== !1,
        Ct = g.namespaceSeparator,
        st = g.isPunctuationChar || /[\[\]{}\(\),;\:\.]/,
        gt = g.numberStart || /[\d\.]/,
        Le = g.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
        Ke = g.isOperatorChar || /[+\-*&%=<>!?|\/]/,
      ...
      function w(R, ne) {
        ...
        if (Y == '"' || Y == "'") return (ne.tokenize = A(Y)), ne.tokenize(R, ne);
        if (gt.test(Y)) {
        ...
        var ve = R.current();
        return j(pe, ve)
          ? (j(le, ve) && (re = 'newstatement'), j(te, ve) && (Ne = !0), 'keyword')
          : j(Re, ve)
          ? 'type'
          : j(ze, ve) || (ht && ht(ve))
      ...
      return {
        ...
        token: function (R, ne) {
          ...
          if (
            ...
            for (Y.type == '}' && (Y = We(ne)); Y.type == 'statement'; ) Y = We(ne);
          } else
            re == Y.type
              ? We(ne)
              : q &&
        ...
        indent: function (R, ne) {
          if ((R.tokenize != w && R.tokenize != null) || (R.typeAtEndOfLine && Ce(R.context)))
            return F.Pass;
          var Y = R.context,
            we = ne && ne.charAt(0),
            ve = we == Y.type;
          if ((Y.type == 'statement' && we == '}' && (Y = Y.prev), g.dontIndentStatements))
            for (; Y.type == 'statement' && g.dontIndentStatements.test(Y.info); ) Y = Y.prev;
          if (he.indent) {
          ...
          return Y.type == 'statement'
            ...
            : Y.type == ')' && !ve
            ? Y.indented + K
            : Y.indented + (ve ? 0 : D) + (!ve && Ot && !/^(?:case|default)\b/.test(ne) ? D : 0);
        },
        electricInput: Ve ? /^\s*(?:case .*?:|default:|\{\}?|\})$/ : /^\s*[{}]$/,
        blockCommentStart: '/*',
        blockCommentEnd: '*/',
        blockCommentContinue: ' * ',
        lineComment: '//',
    ...
    function Me(v, g) {
      if ((v.backUp(1), v.match(/^(?:R|u8R|uR|UR|LR)/))) {
        ...
        return D ? ((g.cpp11RawStringDelim = D[1]), (g.tokenize = X), X(v, g)) : !1;
      }
    ...
    function me(v, g) {
      ...
      K(g.keywords),
        ...
        K(g.builtin),
        K(g.atoms),
        D.length && ((g.helperType = v[0]), F.registerHelper('hintWords', v[0], D));
    ...
    me(['text/x-csrc', 'text/x-c', 'text/x-chdr'], {
        ...
        hooks: {
          ...
          token: function (v, g, D) {
            if (
              D == 'variable' &&
              v.peek() == '(' &&
              (g.prevToken == ';' || g.prevToken == null || g.prevToken == '}') &&
              He(v.current())
            )
              return 'def';
          },
      ...
      me('text/x-csharp', {
        ...
        hooks: {
          '@': function (v, g) {
            return v.eat('"') ? ((g.tokenize = ee), ee(v, g)) : (v.eatWhile(/[\w\$_]/), 'meta');
          },
        },
      });
    function T(v, g) {
    ...
    function H(v) {
      return function (g, D) {
        for (var K; (K = g.next()); )
          ...
          else if (K == '/' && g.eat('*')) return (D.tokenize = H(v + 1)), D.tokenize(g, D);
        return 'comment';
      };
    }
    me('text/x-scala', {
      ...
      hooks: {
        ...
        '=': function (v, g) {
          ...
          return D.type == '}' && D.align && v.eat('>')
            ? ((g.context = new Ee(D.indented, D.column, D.type, D.info, null, D.prev)), 'operator')
            : !1;
        },
        '/': function (v, g) {
    ...
    me('text/x-kotlin', {
      ...
      me('text/x-objectivec', {
        ...
        types: Oe,
        builtin: M(se),
        blockKeywords: M(ae + ' @synthesize @try @catch @finally @autoreleasepool @synchronized'),
      ...
      me('text/x-objectivec++', {
        ...
        builtin: M(se),
        blockKeywords: M(
          ae + ' @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch'
        ),
        defKeywords: M(V + ' @interface @implementation @protocol @class class namespace'),
        dontIndentStatements: /^@.*$|^template$/,
        typeFirstDefinitions: !0,
        atoms: M('YES NO NULL Nil nil true false nullptr'),
        isReservedIdentifier: _e,
    ...
    me('text/x-ceylon', {
      ...
      hooks: {
        ...
        '"': function (v, g) {
          return (g.tokenize = b(v.match('""') ? 'triple' : 'single')), g.tokenize(v, g);
        },
        '`': function (v, g) {
          return !x || !v.match('`') ? !1 : ((g.tokenize = x), (x = null), g.tokenize(v, g));
        },
        "'": function (v) {
          return v.eatWhile(/[\w\$_\xa1-\uffff]/), 'atom';
        },
        token: function (v, g, D) {
          if ((D == 'variable' || D == 'type') && g.prevToken == '.') return 'variable-2';
        },
      },
